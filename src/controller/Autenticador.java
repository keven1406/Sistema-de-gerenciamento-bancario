...
public class Autenticador {
    public Cliente autenticarUsuario (String cpf, String senha, BancoDeDados db) throws SenhaValidacaoException, ClienteNaoEncontradoException, ErroValidacaoNome, ErroValidarCPF {

        Cliente cliente = db.buscarCliente(cpf);
        System.out.println("--------");
